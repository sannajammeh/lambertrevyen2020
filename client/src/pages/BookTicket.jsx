...
const BookTicket = ({
  ...
  const handleSelectChange = e => {
    ...
    setFormData({ ...formData, seats: { ...seats, [name]: value }, ...noErrState });
  };
      ...
      if (err.response?.data) {
        ...
        switch (type) {
          case VALIDATION_ERROR:
            ...
            return bookTicketFailure({ errFields, message: 'Reservasjon avvist, sjekk felter.' });
  ...
  return (
    <div className="container BookTicket">
      ...
      <SpinnerBookingForm
        ...
        {...{ handleChange, handleSelectChange, handleSubmit, prices, formData, count, maxSeats }}
      />
    </div>
  );
};
